...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    'font-semibold rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-opacity-75 transition-all duration-150 ease-in-out flex items-center justify-center';

  const variantStyles = {
    primary: 'bg-sky-500 hover:bg-sky-600 text-white focus:ring-sky-400 disabled:bg-sky-300',
    secondary:
      'bg-gray-600 hover:bg-gray-700 text-gray-100 focus:ring-gray-500 disabled:bg-gray-400',
